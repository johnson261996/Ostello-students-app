...
import 'package:ostello_mentor/pages/student_dashboard/psychometric_test/phase2/phase2congo.dart';
...
class Phase2Que extends StatefulWidget {
  const Phase2Que({Key? key}) : super(key: key);

  @override
  State<Phase2Que> createState() => _Phase2QueState();
}

class _Phase2QueState extends State<Phase2Que> {
                        ...
                        if (_selectedOption != -1) {
                          ...
                          if (_currentQuestionIndex <
                            ...
                            Navigator.of(context).push(
                              PageTransition(
                                type: PageTransitionType.fade,
                                child: const Phase2Congratulations(),
                              ),
                            );
                          }
                        }
