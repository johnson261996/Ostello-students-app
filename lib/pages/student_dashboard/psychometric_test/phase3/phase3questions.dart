...
import 'package:ostello_mentor/pages/student_dashboard/psychometric_test/phase3/phase3congo.dart';
...
class Phase3Que extends StatefulWidget {
  const Phase3Que({Key? key}) : super(key: key);

  @override
  State<Phase3Que> createState() => _Phase3QueState();
}

class _Phase3QueState extends State<Phase3Que> {
                        ...
                        if (_selectedOption != -1) {
                          ...
                          if (_currentQuestionIndex <
                            ...
                            Navigator.of(context).push(
                              PageTransition(
                                type: PageTransitionType.fade,
                                child: const Phase3Congratulations(),
                              ),
                            );
                          }
                        }
